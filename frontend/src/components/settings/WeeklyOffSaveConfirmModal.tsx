...
export function WeeklyOffSaveConfirmModal({
  open,
  onCancel,
  onConfirm,
}: {
  ...
  return (
    <Modal
      ...
      title="Change Default Weekly Off?"
    ...
    >
      <div className="flex items-start gap-3 rounded-lg border border-amber-200/80 bg-amber-50 p-4">
        ...
        <p className="text-sm leading-snug text-slate-700">
          Are you sure you want to change the default weekly off? This change will affect all employees
