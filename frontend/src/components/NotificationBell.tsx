      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="glass-surface-strong glass-shadow absolute right-0 z-50 mt-2 w-[min(20rem,calc(100vw-1.5rem))] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg"
          >
